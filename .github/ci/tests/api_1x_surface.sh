...
static void verify_surface(void) {
    ...
    void (*p_dep_cmake)(C_Dependency *) = c_dep_cmake;
    void (*p_dep_cmake_option)(C_Dependency *, const char *) = c_dep_cmake_option;
    void (*p_dep_link)(C_Dependency *, const char *) = c_dep_link;
    ...
    C_DepKind dep_kinds[] = {
        C_DEP_HEADER_ONLY, C_DEP_CMAKE, C_DEP_RESERVED, C_DEP_SOURCE, C_DEP_CBUILD
    };
    ...
    (void)p_dep_header_only; (void)p_dep_source; (void)p_dep_cmake;
    (void)p_dep_cmake_option; (void)p_dep_link; (void)p_dep_cbuild; (void)p_dep_include;
